...
if ("Ever wondered how we decide who gets to make the big rules? Let's find out!") {
    yield* subtitle().text("Ever wondered how we decide who gets to make the big rules? Let's find out!", 0.4);
...
yield* sequence(0.2,
    ...
    defText().text("Democracy is when the people get to choose their leaders. It's like voting for the next game at recess!", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("You use democracy every time you vote for class president or pick a movie with friends. Everyone gets a say!", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("Here's how democracy turns your voice into action.", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("Like when you and your friends vote on what game to play next. Majority wins!", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("In democracy, everyone gets a vote. In other systems, maybe just one person decides.", 0.5),
);
...
const pointBgs = createRefArray<Rect>();
    ...
    yield* sequence(0.1,
        ...
        pointTexts[0].text("Everyone gets a vote", 0.3),
    ...
    yield* sequence(0.1,
        ...
        pointTexts[1].text("Leaders work for you", 0.3),
    ...
    yield* sequence(0.1,
        ...
        pointTexts[2].text("Your voice matters", 0.3),
