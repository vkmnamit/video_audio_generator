...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("You use queues every day! Printing documents, waiting for your turn in games, even your YouTube videos buffering.", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("Like when you're waiting for your turn in a multiplayer game lobby. No cutting!", 0.5),
);
