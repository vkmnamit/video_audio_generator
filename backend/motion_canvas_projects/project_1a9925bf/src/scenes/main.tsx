...
yield* sequence(0.2,
    ...
    defText().text("It's like a game of 'hot or cold' but for computers. You guess the middle, and eliminate half!", 0.5),
);
...
// Process Flow Scene
const steps = ["Start in the middle", "Is your number higher or lower", "Repeat with the new half"];
...
if ("1. Start in the middle. 2. Is your number higher or lower? 3. Repeat with the new half!") {
    yield* subtitle().text("1. Start in the middle. 2. Is your number higher or lower? 3. Repeat with the new half!", 0.4);
    yield* subtitle().opacity(1, 0.3);
}
...
view.add(
    ...
    yield* sequence(0.1,
        ...
        stepTexts[0].text("Start in the middle", 0.3),
    ...
    yield* sequence(0.1,
        ...
        stepTexts[1].text("Is your number higher or lower", 0.3),
    ...
    yield* sequence(0.1,
        ...
        stepTexts[2].text("Repeat with the new half", 0.3),
...
yield* waitFor(5.0600000000000005);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("Like when you're looking for a page in a book. Open to the middle, then decide to go left or right!", 0.5),
);
...
// Summary Scene
yield* title().text("✅ NOW YOU KNOW", 0.4);
...
const pointBgs = createRefArray<Rect>();
    ...
    yield* sequence(0.1,
        ...
        pointTexts[1].text("Compare and eliminate", 0.3),
...
yield* waitFor(6.249999999999999);
