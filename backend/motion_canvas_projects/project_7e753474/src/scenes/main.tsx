...
yield* sequence(0.2,
    ...
    defText().text("It's like a super-smart guessing game. You split things in half to find what you want FAST.", 0.5),
);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("Imagine finding your favorite song in a playlist of 1000 songs in just 10 guesses!", 0.5),
);
...
// Process Flow Scene
const steps = ["Here's the secret: divide, compare, and conquer"];
...
if ("Here's the secret: divide, compare, and conquer!") {
    yield* subtitle().text("Here's the secret: divide, compare, and conquer!", 0.4);
    yield* subtitle().opacity(1, 0.3);
}
...
view.add(
    ...
    yield* sequence(0.1,
        ...
        stepTexts[0].text("Here's the secret: divide, compare, and conquer", 0.3),
...
yield* waitFor(1.2999999999999998);
...
yield* sequence(0.2,
    ...
    separator().width(cardWidth - 60, 0.3),
    defText().text("It's like when you're guessing a number between 1 and 100, and you start with 50!", 0.5),
);

yield* leftAccent().height(cardHeight, 0.3);
yield* waitFor(3.2800000000000002);
...
const pointBgs = createRefArray<Rect>();
    ...
    yield* sequence(0.1,
        ...
        pointTexts[2].text("Find it in seconds!", 0.3),
