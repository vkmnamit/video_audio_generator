...
// Process Flow Scene
const steps = ["Think of a queue like a line at the movies", "First person in line gets the ticket first", "Simple"];
...
if ("Think of a queue like a line at the movies. First person in line gets the ticket first. Si") {
    yield* subtitle().text("Think of a queue like a line at the movies. First person in line gets the ticket first. Si", 0.4);
    yield* subtitle().opacity(1, 0.3);
}
...
view.add(
    ...
    yield* sequence(0.1,
        ...
        stepTexts[0].text("Think of a queue like a line at the movies", 0.3),
    ...
    yield* sequence(0.1,
        ...
        stepTexts[1].text("First person in line gets the ticket first", 0.3),
...
yield* waitFor(4.390000000000001);
